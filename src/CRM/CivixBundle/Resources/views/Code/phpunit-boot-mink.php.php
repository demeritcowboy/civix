 ...
 *
 * This is mostly copied from drupal's own test bootstrap file. The only real
 * changes are the need to find the project root, and then adding in the
 * usual civi test folders to the autoloader.
 */
